...
describe('GET /v1/drones', () => {
    ...
    it('clamps parameters', async () => {
        const res = await getDrones('/v1/drones?center=58,25&radius_m=99999&n=999');
        expect(res.status).toBe(200);
