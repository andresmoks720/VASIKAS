/**
 * Runtime HTML parser for eAIP ENR 5.1 content - COPY of tooling parser
 * This is a runtime module that duplicates the parsing logic from tools/eaip-import
 * to maintain isolation between tooling and runtime code.
 */

// Version constant for the HTML parser
export const HTML_PARSER_VERSION = "1.0.0";

// Import cheerio for runtime use (this is a browser-compatible version)
 ...
 * This is a copy of the logic from tools/eaip-import/src/htmlParser.ts
 */
